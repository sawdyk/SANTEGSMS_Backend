...
{
    //Parent Class
    public class AddCommentsOnReportsCardReqModel
    {
        [Required]
    ...
    public class CommentsOnReportsCardForAllStudent : AddCommentsOnReportsCardReqModel
    {
        [Required]
    ...
    //Inherits from the parent Class
    public class CommentsOnReportsCardForSingleStudent : AddCommentsOnReportsCardReqModel
    {
        [Required]
